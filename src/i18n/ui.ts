...
export const ui = {
  es: {
    ...
    'projects.title': 'Trabajo seleccionado', 'projects.sub': '/ 03 proyectos', 'projects.name': 'Nombre del proyecto', 'projects.desc': 'Describe en una línea qué resolviste y el impacto. Edita este texto con tu caso real.',
  ...
  en: {
    ...
    'projects.title': 'Selected work', 'projects.sub': '/ 03 projects', 'projects.name': 'Project name', 'projects.desc': 'Describe in one line what you solved and the impact. Edit this text with your real case.',
