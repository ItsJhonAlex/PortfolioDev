...
export default function CollaborationCard({
  ...
  const content = collaboration.content[locale];
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-3 aspect-[4/3] overflow-hidden bg-cafe-border">
        ...
        <span
          aria-hidden="true"
          className="absolute bottom-1.5 left-2 inline-flex items-center gap-1 font-mono text-[8px] uppercase tracking-widest text-white/70"
        >
      ...
      <p className="mt-3 px-2 font-mono text-[10px] lowercase tracking-wide text-cafe-accent">
        ✦ {content.role}
      </p>

      {collaboration.link && (
        <div className="mt-3 flex items-center justify-center border-t border-dashed border-cafe-border px-2 pt-3 text-xs text-cafe-mute">
          <a
